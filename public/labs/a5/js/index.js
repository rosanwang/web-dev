...
//concise alternative to the if statement
...
//determine the index where an element is located in an array
...
//const variables can not be redeclared or reassigned
const isLoggedIn = false;
const greeting2 = `Logged in: ${isLoggedIn ? "Yes" : "No"}`;
console.log(greeting2);

//Executing jQuery Scripts
//jQuery waits for the document to load, DOM to generate, then is initialized
const init = () => {
